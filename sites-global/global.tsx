...
export const favicon = "https://a.mktgcdn.com/p-sandbox/2of94YrjHBi1ABi7IcGlDmICSA4MfOr1izB4O_5ZJUE/626x417.jpg";
export const apiKey = "d60994ed113be6d9714d9dcbae2bc189";
...
export const center_latitude = 40.273502;
//export const center_longitude=-0.1244828354;
export const center_longitude = -86.126976;
...
<path d="M877,4760h5a1,1,0,0,0,1-1v-8.59l.293.3a1,1,0,1,0,1.414-1.42l-9-9a1,1,0,0,0-1.414,0l-9,9a1,1,0,0,0,1.414,1.42l.293-.3V4759a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1v-5h2v5A1,1,0,0,0,877,4760Zm4-2h-3v-5a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1v5h-3v-9.59l6-6,6,6Z" transform="translate(-865 -4739.998)" fill="black" fill-rule="evenodd"/>
</svg>`;
...
export const search_icn = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 30.938 30.579"><g id="Icon_feather-search" data-name="Icon feather-search" transform="translate(-3 -3)"><path id="Path_39" data-name="Path 39" d="M24.691,14.6A10.1,10.1,0,1,1,14.6,4.5,10.1,10.1,0,0,1,24.691,14.6Z" transform="translate(0 0)" fill="white" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path><path id="Path_40" data-name="Path 40" d="M35.066,34.707,24.975,24.975" transform="translate(-3.249 -3.249)" fill="white" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path></g></svg>`;
